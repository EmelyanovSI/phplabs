...
$first = '';
if (!empty($_GET))
    $_SESSION['test']['first'] = $_GET['first'];
if (isset($_SESSION['test']['first']))
    $first = $_SESSION['test']['first'];
?>
    ...
    <div class="forms">
        <form name="test1">
            <fieldset>
                ...
                <input id="first" name="first" type="text" placeholder="01" value="<?php echo $first; ?>" required>
